...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val etButton01 = findViewById<Button>(R.id.etButton01)
        val etButton02 = findViewById<Button>(R.id.etButton02)

        //nastavení pro tlačítko odeslat
        etButton01.setOnClickListener{
